({
                ...
                if(response!=null && response!=undefined){
                    if(response.workforceCategory==null||response.workforceCategory==undefined||
                       response.specRequirement==null||response.specRequirement==undefined){
                        console.log('accountantCategory or specRequirement  is null');     
                    }
                    component.set("v.accountantCategory",response.workforceCategory);
                 ...
                 component.set('v.loaded', !component.get('v.loaded'));
                alert('Internal Error. Accountant Information not populated. Please Try again or Contact System Admin.');
            }
            else{
                 component.set('v.loaded', !component.get('v.loaded'));
    ...
    handleAddOtherCostHelper: function(component,existingData){
        $A.createComponent(
            "c:ET_OtherCostPerRequirementCmp",{
                "aura:id" : "accountantOtherCostCmp",
    ...
    validateOtherCostFieldsPerTab: function(component,event,helper){
        ...
        var isValid = true;
        var OtherCostCmps = component.find('accountantOtherCostCmp');

({
    setCommunityLanguage : function(component, event, helper) {
        ...
        if(lang == 'ar'){
            ...
            component.set("v.MROGeneral", $A.get("$Label.c.MRO_General"));
            component.set("v.MROComplainagainstexistingservice", $A.get("$Label.c.MRO_Complain_against_existing_service"));
            component.set("v.MROVECHILNUMBER", $A.get("$Label.c.MRO_Internal_Vehicle_number_fleet_information"));
        } else {
          ...
          component.set("v.MROComplainagainstexistingservice", $A.get("$Label.c.MRO_Complain_against_existing_service"));
            component.set("v.MROVECHILNUMBER", $A.get("$Label.c.MRO_Internal_Vehicle_number_fleet_information"));
             component.set("v.MROLOCATION", $A.get("$Label.c.MRO_Location"));
             component.set("v.MRODescription", $A.get("$Label.c.MRO_Description"));
             component.set("v.MROWorkshops", $A.get("$Label.c.MRO_Workshops"));
              component.set("v.MROResource", $A.get("$Label.c.MRO_Resource"));

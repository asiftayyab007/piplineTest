({ 
        ...
        action.setCallback(this, function(response) {            
            if (response.getState() == "SUCCESS") {
                ...
                if(moveNextstepOnCompletion==true){   
                  /*  var seq_3_initialState=component.get("v.seq_3_initialState");
                    if(current_sequence ==3 && seq_3_initialState =='No'){
                        component.set("v.current_sequence",(current_sequence+3));
                    }
                    else{
    ...
    getStageRecordtypeId: function(component, event, helper){
        ...
        action.setParams({
            ...
            'recordTypeDeveloperName': 'Painting'
        });
        action.setCallback(this, function(response) {            
            if (response.getState() == "SUCCESS") {

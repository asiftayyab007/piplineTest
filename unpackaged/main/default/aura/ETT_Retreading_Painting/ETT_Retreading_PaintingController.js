({
        ...
        if(allowDML){
            if(step_error==null || step_error==''){
                if (flag && WearRequiredPPT) {
                    ...
                    line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Work_Schedule__c=component.get("v.workSheduleInfo.Id");
                    line.relatedJobWrapper.validJobCardList[0].ETT_painting_technician__c= $A.get("$SObjectType.CurrentUser.Id");
                    ...
                    Nextlineitem.ETT_Activity_Performed__c='Painting Check Tyres Sidewall Painted';
    ...
    goToStep3 : function(component, event, helper) {
        ...
        var newToolReq=component.get("v.newToolRequests");
         ...
         if(line.jobLineItem.ETT_Final_Activity_State__c =='No'){
            ...
            var Nextlineitem=component.get("v.Nextlineitem");
            Nextlineitem.Id=null;
            Nextlineitem.ETT_Activity_Performed__c='Painting Check Excessive Paint Leakage';
            Nextlineitem.ETT_Type__c='Pre-Requisite Work';
            Nextlineitem.ETT_Status__c='Not Started';
    ...
    goToStep4 : function(component, event, helper) {
        ...
        var line=component.get("v.current_line");
            ...
            let status= line.jobLineItem.ETT_Initial_Activity_State__c;
            //if(status == 'Yes'){
                 
                Nextlineitem.ETT_Activity_Performed__c='Painting Check Sidewall Painting Leakage'; 
            //}else{
           ...
           // }
            ...
            nextWorkTracker.Id=null;
            nextWorkTracker.ETT_Start_time__c=$A.localizationService.formatDateTime(new Date(),'YYYY-MM-DDThh:mm:ss.SSSZ');   
        	component.set("v.seq_3_initialState",line.jobLineItem.ETT_Initial_Activity_State__c);
    ...
    goToStep5 : function(component, event, helper) {
        ...
        var line=component.get("v.current_line");
            ...
            var Nextlineitem=component.get("v.Nextlineitem");
            Nextlineitem.Id=null;
            Nextlineitem.ETT_Activity_Performed__c='Painting Check Inner Side of Tyre Casing';
            Nextlineitem.ETT_Type__c='Pre-Requisite Work';
            Nextlineitem.ETT_Status__c='Not Started';
    ...
    goToStep7 : function(component, event, helper) {
        ...
        var Nextlineitem=component.get("v.Nextlineitem");
        Nextlineitem.Id=null;
        Nextlineitem.ETT_Activity_Performed__c='Final Stage Check';//Tyre Cementing Check';
        Nextlineitem.ETT_Type__c='Pre-Requisite Work';
        Nextlineitem.ETT_Status__c='Not Started';
    ...
    goToStep8: function(component,event,helper){
        ...
        if($A.util.isUndefinedOrNull(line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Status__c) || line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Status__c==""){ 
            component.set("v.step_error","Status is mandatory to end.");
        }
        else if(line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Status__c=='Accepted' && ($A.util.isUndefinedOrNull(selectedNextStation) || selectedNextStation=="")){ 
            component.set("v.step_error","Next stage should be selected when accepting.");
        } 
        else{
            if(line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Status__c=='Initial Rejection'){
            ...
            if($A.util.isUndefinedOrNull(line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Technician_Remarks__c)){
                line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Technician_Remarks__c='';
            }
            if($A.util.isUndefinedOrNull(line.jobLineItem.ETT_Remarks__c)){
                line.jobLineItem.ETT_Remarks__c='';
            }            
            line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Technician_Remarks__c='Version:'+line.relatedJobWrapper.validJobCardList[0].ETT_No_Of_Painting_Revisions__c+' :'+line.jobLineItem.ETT_Remarks__c+'\n'+line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Technician_Remarks__c;//append the technician remarks
    ...
    confirmOnHold: function(component,event,helper){
        ...
        if(lineItemForHoldWrapper.jobLineItem.ETT_Pause_Reason__c==null || lineItemForHoldWrapper.jobLineItem.ETT_Pause_Reason__c==""){
            ...
            lineItemForHoldWrapper.jobLineItem.ETT_Revision_Number__c=line.relatedJobWrapper.validJobCardList[0].ETT_No_Of_Painting_Revisions__c;
    ...
    reportDefectsAndEnd: function(component,event,helper){
        ...
        if($A.util.isUndefinedOrNull(selectedNextStation) || selectedNextStation==null || selectedNextStation=="" || selectedDefects.length==0){
            ...
            line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Technician_Remarks__c='Version(Defect found):'+line.relatedJobWrapper.validJobCardList[0].ETT_No_Of_Painting_Revisions__c+' :'+line.jobLineItem.ETT_Remarks__c+'\n'+line.relatedJobWrapper.validJobCardList[0].ETT_Painting_Technician_Remarks__c;//append the technician remarks

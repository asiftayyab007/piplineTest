({
    doInit : function(component, event, helper) {
        ...
        // var AccountLocation = component.get("v.stgFleetInspectRecordLocation.ETT_Location__c");
        // var name = component.get("v.stgFleetInspectRecord.Name");
        //  alert(name);
        //   component.set("v.FleetInspectionObj.ETT_Location__c",AccountLocation);
       ...
       FleetInspectionLineItemList.push({
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set('v.newAccount',res);
            }
  ...
  //                  alert(e.target.type);
    ...
    clickCreate : function(component, event, helper){
     ...
     component.set("v.FleetInspectionLineItemList",FleetInspectionLineItemList);
         ...
         // FleetInspectionObj.ETT_Internal_Number__c==null||FleetInspectionObj.ETT_Internal_Number__c==''||
           ...
           FleetInspectionObj.ETT_Odo_Meter__c==null || FleetInspectionObj.ETT_Odo_Meter__c==''
            ...
            helper.showErrorToast({
                "title": "Required:",
                "type": "error",
                "message": "Vehicle No, Vehicle Config, Party Type, Type, Type Model,Minimum Pull Point, Odo Meter Fields are required"
            });
            return false; 
        }
        else{
            FleetInspectionObj.Name = component.get("v.newAccount.Name");
            
         //   FleetInspectionObj.ETT_Location__c = component.get("v.newAccount.ETT_Location__c");
            FleetInspectionObj.ETT_Account__c = component.get("v.recordId");
          	FleetInspectionObj.ETT_Party_Type__c =  component.get("v.newAccount.Party_Type__c");
          
            if(FleetInspectionObj.ETT_Party_Type__c=="Internal Project")
            {
                if(!FleetInspectionObj.ETT_Internal_Number__c)
                    
                {
                        helper.showErrorToast({
                "title": "Required:",
                "type": "error",
                "message": "Internal No Fields are required"
            });
            return false;  
                }
            ...
            if(FleetInspectionLineItemList[k].Tyre_Position__c)
            {
               // alert(FleetInspectionLineItemList[k].Tyre_Position__c);
                ...
                if((FleetInspectionLineItemList[k].Tyre_Status__c=="Hot"||FleetInspectionLineItemList[k].Tyre_Status__c=="Precured")&&(FleetInspectionLineItemList[k].Retreader__c==""||FleetInspectionLineItemList[k].Retreader__c==null)){
                    ...
                    helper.showErrorToast({
                        "title": "Required:",
                        "type": "error",
                        "message": "Retread Fields are required"+FleetInspectionLineItemList[k].Tyre_Position__c
                    });
                    return false; 
                }
                ...
                if(!FleetInspectionLineItemList[k].ETT_Tyre_Size__c&&!FleetInspectionLineItemList[k].ETT_Tyre_Size_Name__c){
                    ...
                    helper.showErrorToast({
                        "title": "Required:",
                        "type": "error",
                        "message": "Tyre Size Fields are required"+FleetInspectionLineItemList[k].Tyre_Position__c
                    });
                    return false; 
                }
               if(!FleetInspectionLineItemList[k].ETT_Brand__c&&!FleetInspectionLineItemList[k].ETT_Tyre_Brand_Name__c){
                    ...
                    helper.showErrorToast({
                        "title": "Required:",
                        "type": "error",
                        "message": "Casing Brand Fields are required"+FleetInspectionLineItemList[k].Tyre_Position__c
                    });
                    return false; 
                }
        ...
        newAccount.Id = component.get("v.recordId");
        var stgAccountJson = JSON.stringify(newAccount);
        console.log(stgAccountJson);
        ...
        var mapNameForStagingObjects = {"stgAccountJson":stgAccountJson,

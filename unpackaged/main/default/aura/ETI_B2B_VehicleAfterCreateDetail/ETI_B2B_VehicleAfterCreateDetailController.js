({
    ...
    saveVehicleDetails: function(component, event, helper) {
        ...
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": '/Business/s/home-inspection?Loc='+component.get("v.selectedEmirate")+'&lang='+component.get("v.clLang")                            
        });
        urlEvent.fire();
    },
    ...
    requestforservicepage:function(component, event, helper) {
        try{
            ...
            var CurrentDate = $A.localizationService.formatDateUTC(today, "YYYY-MM-DD");
            console.log('Reg Date ', data.Registration_Expiry_Date__c);
            console.log('CurrentDate ', CurrentDate);
            if(component.get('v.selectedEmirate')=='Sharjah' && data.Registration_Expiry_Date__c!=undefined 
               && data.Registration_Expiry_Date__c!='' && data.Registration_Expiry_Date__c>CurrentDate){
                var msg=component.get("v.You_cannot_Request_Service_Message");
                var utility = component.find("ETI_UtilityMethods");

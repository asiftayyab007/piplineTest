({
    ...
    openRecord: function(component,event,helper){
        ...
        let reason = selectedItem.dataset.index;
        
        if(reason === 'Vehicle Theft' || reason === 'Scrapped Vehicle Theft'){
            component.set('v.showVehicleTheft',true);
        }else{
            component.set('v.showVehicleTheft',false);
        }
    ...
    submitDetails: function(component, event, helper) {
        helper.uploadHelper(component,event, 'fileId', component.get("v.recordId"));
    },

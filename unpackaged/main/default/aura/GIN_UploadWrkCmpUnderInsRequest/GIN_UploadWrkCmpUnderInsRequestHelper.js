({
    ...
    insertLineItems : function (component,jsonstr){
       ...
       var action = component.get('c.insertDataWorkCompUnderInsReq');
        //  alert('Server Action' + action);    
        action.setParams({
            strfromle : jsonstr,
            recordID:recid,
            requestType: component.get("v.requestType"),
            policyId: component.get("v.InsurancePolicyId")
        });
    ...
    convertArrayOfObjectsToCSV : function(component,objRecords,type) {
        ...
        columnDivider=',';
        lineDivider='\n';
        keys=['Employee__r','Job_Title__c','Finance_No__c','Zone__c','Monthly_Salary__c'];
        
        
        csvStringResult='';
        //csvStringResult+=keys.join(columnDivider);
        csvStringResult+=['Name','Job Title','Finance No.','Zone','Monthly Salary'];

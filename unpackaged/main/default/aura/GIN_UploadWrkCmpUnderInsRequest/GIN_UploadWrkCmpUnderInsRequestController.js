({
	doInit : function(component, event, helper) {
        ...
        var action = component.get('c.getInsLinesByInsReqId');
    ...
    onForceLoad : function(component, event, helper) {
        ...
        let ReqType = recordData.Request_Type__c;
        let policy = recordData.Insurance_Policy__c;
        component.set("v.requestType",ReqType);
        component.set("v.InsurancePolicyId",policy);
    },
    ...
    DownloadTemplate : function(component){
        ...
        var jsonStr = '{"rows":[{"vals":[{"val":"12355"}]},{"vals":[{"val":"34233"}]}],"headers":[{"title":"FinanceNumber"}]}';
        ...
        hiddenElement.download = 'WorkCompSampleTemplate'+'.csv'; 
        hiddenElement.click();
    },
     ...
     downloadRecords :function(component, event, helper){
        ...
        elementLink.download='WorkCompEmployees.csv';

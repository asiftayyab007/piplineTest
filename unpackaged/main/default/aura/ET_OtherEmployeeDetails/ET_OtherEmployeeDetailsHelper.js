({
        ...
        action.setCallback(this, function(a) {
            ...
            if (state === "SUCCESS"){
                ...
                if(response!=null && response!=undefined){
                    if(response.workforceCategory==null||response.workforceCategory==undefined||
                        response.specRequirement==null||response.specRequirement==undefined){
                            console.log('empCategory or specRequirement  is null');     
                    }
                component.set("v.empCategory",response.workforceCategory);
                ...
                if(response.contractPeriods!=null && response.contractPeriods!=undefined){
                 ...
                 component.set('v.loaded', !component.get('v.loaded'));
                alert('Internal Error.Other Employee Information not populated. Please Try again or Contact System Admin.');
            }
            else{
                 component.set('v.loaded', !component.get('v.loaded'));
    ...
    validateOtherCostFieldsPerTab: function(component,event,helper){
        ...
        var isValid = true;
        var OtherCostCmps = component.find('otherEmpOtherCostCmp');

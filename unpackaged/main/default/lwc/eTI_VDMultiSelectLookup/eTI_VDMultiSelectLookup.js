...
import retrieveRecords from '@salesforce/apex/ETI_VDLookupController.retrieveRecords';
					...
					if (result.length > 0) {
						result.map(resElement => {
							...
							this.items = [...this.items, {
								...
								name: resElement.recordObj.Id__c,
								label: resElement.recordObj.Id__c + ' ' + resElement.recordObj.Test_Type_Name_En__c + ' ' + resElement.recordObj.Test_Type_Name_Ar__c
							}];
